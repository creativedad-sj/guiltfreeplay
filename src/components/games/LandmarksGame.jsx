...
export default function LandmarksGame() {
  const {
    currentItem,
    shuffledItems,
    score,
    ...
    handleItemClick,
    speak,
  } = useCategoryGame(landmarks, 'landmarks-game', 'Landmarks');

  const { imageErrors, loading } = useImagePreloader(landmarks);
  ...
  return (
    <GameLayout title="Famous Landmarks" score={score}>
